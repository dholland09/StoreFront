...
namespace StoreFront.UI.MVC.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        {
            var storeFrontContext = _context.OrderProducts.Include(o => o.Cheese).Include(o => o.Order);
        ...
        {
            ViewData["CheeseId"] = new SelectList(_context.Cheeses, "CheeseId", "Name");
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,CheeseId,OrderId,Quantity,Price")] OrderProduct orderProduct)
        {
            ...
            ViewData["CheeseId"] = new SelectList(_context.Cheeses, "CheeseId", "Name", orderProduct.CheeseId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderProductId,CheeseId,OrderId,Quantity,Price")] OrderProduct orderProduct)
        {
